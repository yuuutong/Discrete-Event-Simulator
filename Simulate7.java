...
public class Simulate7 {
    ...
    public Simulate7(int numOfServers, List<Pair<Double, 
        Supplier<Double>>> inputTimes, int qmax, Supplier<Double> restTimes) {
        this.numOfServers = numOfServers;
        this.customerArrivalTime = getCustArrivalTime(inputTimes);
        this.pq = formPQ(inputTimes);
        this.shop = formShop(numOfServers, qmax, restTimes);
        this.customers = formCustomer(inputTimes);
        this.stats = new Statistic(0.0, 0, 0);
    }
    ...
    public Simulate7(Shop shop, PQ<Event> pq, ImList<Customer> customers, Statistic stats) {
    ...
    public static Shop formShop(int numOfServers, int qmax, Supplier<Double> restTimes) {
        ImList<Server> serverList = ImList.<Server>of();
        for (int i = 1; i <= numOfServers; i++) {
    ...
    public String run() {
        ...
        while (!curr.pq.isEmpty()) {
            ...
            if (event.getType().equals("Leave")) {
                ...
                curr = new Simulate7(curr.shop, curr.pq, curr.customers, updatedStats);
            }
            ...
            curr = new Simulate7(updatedShop, updatedpq, curr.customers, curr.stats);
        }
